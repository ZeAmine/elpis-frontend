  ...
  return (
    <div className="register">
      <div className="register__wrapper">
        ...
        {/*--------------Profil----------------*/}
        <div className="register__profil" style={{ display: !profilConfig && "none" }}>
          <div className="register__profil__top">
            <h1 className="register__profil__top__title">
              {`Bonjour, ${firstName} !`}
            </h1>
            <p className="register__profil__top__subtitle">
              Afin de vous aider au mieux. Comment voulez-vous personnaliser votre profil ?
            </p>
          </div>
          <div className="register__profil__checkbox--refugee">
            <label className="register__profil__checkbox__container">
              <input type="checkbox" className="register__profil__checkbox__input"/>
              <div className="register__profil__checkbox__content">
                <span className="register__profil__checkbox__icon">
                ...
                <span className="register__profil__checkbox__block">
                  <h4 className="register__profil__checkbox__block__label">Personne réfugié</h4>
                  <p className="register__profil__checkbox__block__text">
          ...
          <div className="register__profil__checkbox--solidarity" onClick={() => setSolidarity(!solidarity)}>
            <label htmlFor="solidarity" className="register__profil__checkbox__container">
              <input type="checkbox" id="solidarity" className="register__profil__checkbox__input"/>
              <div className="register__profil__checkbox__content">
                <span className="register__profil__checkbox__icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <g fill="currentColor">
                ...
                <span className="register__profil__checkbox__block">
                  <h4 className="register__profil__checkbox__block__label">Voisin solidaire</h4>
                  <p className="register__profil__checkbox__block__text">
