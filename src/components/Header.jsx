    ...
    <header className="header">
      <div className="header__wrap">
        <Link to="/" className="header__brand">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 201.84 68.07" width="134">
          ...
          <ul className="header__nav__list">
            ...
            <li className="header__nav__item">
              <div className="header__nav__item__btns">
                <Link to="/connection">
                  <button className="header__nav__item__btn login">
                    <span>connection</span>
                  </button>
                </Link>
                <Link to="/inscription">
                  <button className="header__nav__item__btn register">
