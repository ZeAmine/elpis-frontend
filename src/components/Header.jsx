    ...
    <header className="header">
      <div className="header__wrap">
        <Link to="/" className="header__brand">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 201.84 68.07" width="115">
...
{/*      <a href="#" className="header__nav__link">Communauté</a>*/}
{/*    </li>*/}
{/*    <li className="header__nav__item">*/}
{/*      <a href="#" className="header__nav__link">Notre histoire</a>*/}
{/*    </li>*/}
{/*    <li className="header__nav__item">*/}
{/*      <a href="#" className="header__nav__link">Nos valeurs</a>*/}
{/*    </li>*/}
{/*    <li className="header__nav__item">*/}
{/*      <a href="#" className="header__nav__link">Fonctionnement</a>*/}
{/*    </li>*/}
{/*    <li className="header__nav__item">*/}
{/*      <a href="#" className="header__nav__link">Nos partenaires</a>*/}
{/*    </li>*/}
{/*  </ul>*/}
{/*</nav>*/}
